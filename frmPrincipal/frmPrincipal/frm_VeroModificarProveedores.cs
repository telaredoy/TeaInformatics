...
{
    public partial class frm_VeroModificarProveedores : Form
    {
        private Conexion c = Conexion.getintance();
        private DataTable dtClientes;
        private int IdSelect = -1;
        public frm_VeroModificarProveedores()
        {
            InitializeComponent();
            UpdateTabla();
        }
        ...
        private void UpdateTabla()
        {
            ...
            lv_Clientes.Items.Clear();
            OleDbDataReader DBdatareader = c.ConsultaDatos("SELECT * FROM Proveedores;");
